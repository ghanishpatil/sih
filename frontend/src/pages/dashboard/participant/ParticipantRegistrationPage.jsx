...
export function ParticipantRegistrationPage() {
  ...
  }, [team, user]) // Added user dependency
  ...
  // BUG FIX: Calculate isLeader by comparing user.uid with team.leaderId
  // The team object doesn't have an isLeader property!
  const isLeader = user?.uid && team?.leaderId === user.uid
